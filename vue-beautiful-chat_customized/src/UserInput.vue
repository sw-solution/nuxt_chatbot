<template>
  <div>
    ...
    <form class="sc-user-input" v-show="enable_chat" :class="{active: inputActive}" :style="{background: colors.userInput.bg}">
      <div class="sc-user-input--icons" v-if="input_icon">
        <div class="sc-user-input--icon">
          <img :src="input_icon" alt="" width="100%" >
        </div>
      </div>
      <div class="sc-user-input--wrapper" :class="{ 'has-icon': input_icon }">
        <div
          role="button"
          tabIndex="0"
    ...
    <ChatTerms :terms="terms" :colors="colors"/>
  </div>
</template>
...
import ChatTerms from './ChatTerms.vue'
